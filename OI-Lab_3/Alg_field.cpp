...
Mat Sobel(Mat image) {
    ...
    Mat result = Mat(image.rows - 2, image.cols - 2, CV_8UC3);
...
Mat nonMax(Mat image) {
    ...
    for (int i = 1; i < image.rows - 1; i++) {
        for (int j = 1; j < image.cols - 1; j++) {
            ...
            if ((((-22.5 < t[0]) && (t[0] <= 22.5)) ||
               ((157.5 < t[0]) && (t[0] <= -157.5))) && (((-22.5 < t[1]) && (t[1] <= 22.5)) ||
               ((157.5 < t[1]) && (t[1] <= -157.5))) && (((-22.5 < t[2]) && (t[2] <= 22.5)) ||
               ((157.5 < t[2]) && (t[2] <= -157.5)))) {
                if (((image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i, j + 1)[0]) ||
                   (image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i, j - 1)[0])) && ((image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i, j + 1)[1]) ||
                   (image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i, j - 1)[1])) && ((image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i, j + 1)[2]) ||
                   (image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i, j - 1)[2]))) {
                    res.at<Vec3b>(i - 1, j - 1) = Vec3b(0, 0, 0);
                }
            }
            if ((((-112.5 < t[0]) && (t[0] <= -67.5)) ||
               ((67.5 < t[0]) && (t[0] <= 112.5))) && (((-112.5 < t[1]) && (t[1] <= -67.5)) ||
               ((67.5 < t[1]) && (t[1] <= 112.5))) && (((-112.5 < t[2]) && (t[2] <= -67.5)) ||
               ((67.5 < t[2]) && (t[2] <= 112.5)))) {
                if (((image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i + 1, j)[0]) ||
                   (image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i - 1, j)[0])) && ((image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i + 1, j)[1]) ||
                   (image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i - 1, j)[1])) && ((image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i + 1, j)[2]) ||
                   (image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i - 1, j)[2]))) {
                    res.at<Vec3b>(i - 1, j - 1) = Vec3b(0, 0, 0);
                }
            }
            if ((((-67.5 < t[0]) && (t[0] <= -22.5)) ||
               ((112.5 < t[0]) && (t[0] <= 157.5))) && (((-67.5 < t[1]) && (t[1] <= -22.5)) ||
               ((112.5 < t[1]) && (t[1] <= 157.5))) && (((-67.5 < t[2]) && (t[2] <= -22.5)) ||
               ((112.5 < t[2]) && (t[2] <= 157.5)))) {
                if (((image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i - 1, j + 1)[0]) ||
                   (image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i + 1, j - 1)[0])) && ((image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i - 1, j + 1)[1]) ||
                   (image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i + 1, j - 1)[1])) && ((image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i - 1, j + 1)[2]) ||
                   (image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i + 1, j - 1)[2]))) {
                    res.at<Vec3b>(i - 1, j - 1) = Vec3b(0, 0, 0);
                }
            }
            if ((((-157.5 < t[0]) && (t[0] <= -112.5)) ||
               ((22.5 < t[0]) && (t[0] <= 67.5))) && (((-157.5 < t[1]) && (t[1] <= -112.5)) ||
               ((22.5 < t[1]) && (t[1] <= 67.5))) && (((-157.5 < t[2]) && (t[2] <= -112.5)) ||
               ((22.5 < t[2]) && (t[2] <= 67.5)))) {
                if (((image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i + 1, j + 1)[0]) ||
                   (image.at<Vec3b>(i, j)[0] < image.at<Vec3b>(i - 1, j - 1)[0])) && ((image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i + 1, j + 1)[1]) ||
                   (image.at<Vec3b>(i, j)[1] < image.at<Vec3b>(i - 1, j - 1)[1])) && ((image.at<Vec3b>(i, j)[2] < image.at<Vec3b>(i + 1, j + 1)[2]) ||
                ...
                for (int x = i - 1; x <= i + 1; ++x) {
                    for (int y = j - 1; y <= j + 1; ++y) {
                        if (x <= 0 || y <= 0 || edge.rows || y > edge.cols) continue;
                            ...
                            if (edge.at<Vec3b>(x, y)[0] > b &&
                                edge.at<Vec3b>(x, y)[1] > b &&
                                edge.at<Vec3b>(x, y)[2] > b) {
                                edge.at<Vec3b>(i, j) = Vec3b(255, 255, 255);
                                H = 1;
                                break;
                            }
                            else if (edge.at<Vec3b>(x, y)[0] <= b &&
                                edge.at<Vec3b>(x, y)[0] >= a &&
                                edge.at<Vec3b>(x, y)[1] <= b &&
                                edge.at<Vec3b>(x, y)[1] >= a &&
                                edge.at<Vec3b>(x, y)[2] <= b &&
                                edge.at<Vec3b>(x, y)[2] >= a) {
                                calc = 1;
                            }
                        }
                    }
